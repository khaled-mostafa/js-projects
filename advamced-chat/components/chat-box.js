class ChatBox extends Component {
    ...
    return `
            <template>
                ...
                <div class="chat-placeholder">
                    ...
                    <h2>Hi there, muraho! \n Select a chat to start messaging. Muryoherwe.</h2>
                    <p>This app is one of the projects that I developed for educational purposes. 
                    This project developed with <strong>Web Components</strong> without any third-party libraries.</p>
                </div>
            </template>
            `;
  }
  ...
  constructor() {
    ...
    this._scrollToBottomBtn =
      this.shadowRoot.getElementById("scroll-to-bottom");
